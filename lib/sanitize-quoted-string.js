 ...
 *
 * Escapes backslashes and double-quotes and strips control characters (CR, LF, NUL)
 * so the result is safe for inclusion between double-quote delimiters in HTTP headers
 * such as `WWW-Authenticate`, `Link`, and `Set-Cookie`.
 *

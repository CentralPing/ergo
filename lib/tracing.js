 ...
 * const span = tracer.startSpan('operation', {attributes: {'http.request.method': 'GET'}});
 * // ... do work ...
...
/**
 * TextMapGetter for reading HTTP headers during context extraction.
 *
 * Implements the OTEL `TextMapGetter` interface — `get()` for individual
 * header lookup and `keys()` for enumerating all header names.
 *
 * @type {import('@opentelemetry/api').TextMapGetter<object>}
 */

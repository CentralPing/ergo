...
describe('[Boundary] lib/csrf', () => {
  describe('issue()', () => {
    ...
    it('throws TypeError when secret is missing', () => {
      assert.throws(() => issue(), {
        name: 'TypeError',
        message: 'Missing required parameter: "secret"'
      });
    });

    it('throws TypeError when secret is not a string', () => {
      assert.throws(() => issue(null), {
        name: 'TypeError',
        message: 'Missing required parameter: "secret"'
      });
      assert.throws(() => issue(42), {
        name: 'TypeError',
        message: 'Missing required parameter: "secret"'
      });
    });
  ...
  describe('verify()', () => {
    ...
    it('throws TypeError when secret is missing', () => {
      assert.throws(() => verify('tok', {uuid: 'u1'}), {
        name: 'TypeError',
        message: 'Missing required parameter: "secret"'
      });
    });
    ...
    it('throws TypeError when uuid is missing', () => {
      assert.throws(() => verify('tok', {secret: 's1'}), {
        name: 'TypeError',
    ...
    it('throws TypeError when secret is not a string', () => {
      assert.throws(() => verify('tok', {secret: null, uuid: 'u1'}), {
        name: 'TypeError',
        message: 'Missing required parameter: "secret"'
      });
      assert.throws(() => verify('tok', {secret: 42, uuid: 'u1'}), {
        name: 'TypeError',
        message: 'Missing required parameter: "secret"'
      });
    });

    it('throws TypeError when uuid is not a string', () => {
      assert.throws(() => verify('tok', {secret: 's1', uuid: null}), {
        name: 'TypeError',
        message: 'Missing required parameter: "uuid"'
      });
      assert.throws(() => verify('tok', {secret: 's1', uuid: 42}), {
        name: 'TypeError',
        message: 'Missing required parameter: "uuid"'
      });
    });

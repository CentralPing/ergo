...
describe('lib/tracing', () => {
  ...
  describe('injectContext()', () => {
    it('calls setHeader on response when headersSent is false', () => {
      const headers = {};
      const res = {
        headersSent: false,
        setHeader(k, v) {
      ...
      // Without a registered propagator, no headers are injected.
      // The test verifies the function does not throw.
    });

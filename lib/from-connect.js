 ...
 *
 * Returns `undefined` so the accumulator is unaffected (`Object.assign(acc, undefined)`
 * is a no-op). Connect middleware communicates via side effects on `res` headers.
 *
 * Limitations:

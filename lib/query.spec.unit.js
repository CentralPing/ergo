...
describe('[Boundary] lib/query', () => {
  ...
  describe('malformed bracket keys', () => {
    ...
    it('skips conflicting nested key after scalar (first-wins): a=42&a[b]=99 (#354)', () => {
      ...
      assert.equal(Object.hasOwn(result, 'a') && typeof result.a === 'string', true);

...
describe('[Boundary] lib/validate-location', () => {
  ...
  describe('embedded control character bypass prevention', () => {
    it('throws for tab embedded in javascript:', () => {
    ...
    it('throws for newline embedded in javascript:', () => {
    ...
    it('throws for carriage return embedded in javascript:', () => {
    ...
    it('throws for mixed control characters in javascript:', () => {
    ...
    it('throws for tab embedded in data:', () => {
      assert.throws(() => validateLocation('da\tta:text/html,xss'), {
        name: 'TypeError',
        message: /dangerous URI scheme: "data"/
      });
    });

    it('throws for newline embedded in vbscript:', () => {
      assert.throws(() => validateLocation('vb\nscript:code'), {
        name: 'TypeError',
        message: /dangerous URI scheme: "vbscript"/
      });
    });

...
interface CsrfMiddleware {
  ...
  verify: (req: { headers?: Record<string, string | undefined> }, res: import('node:http').ServerResponse, acc: { cookies?: CookieJar }) => undefined | { response: { statusCode: 403; detail: string } };
}
